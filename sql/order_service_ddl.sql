...
CREATE TABLE IF NOT EXISTS `future_order`.`orders` (
    ...
    status ENUM('PENDING', 'CONFIRMED', 'CANCELLED', 'SHIPPED', 'DELIVERED') NOT NULL DEFAULT 'PENDING' COMMENT '订单状态',
...
CREATE TABLE IF NOT EXISTS `future_order`.`order_events` (
    ...
    previous_status ENUM('PENDING', 'CONFIRMED', 'CANCELLED', 'SHIPPED', 'DELIVERED') NOT NULL COMMENT '变更前状态',
    new_status ENUM('PENDING', 'CONFIRMED', 'CANCELLED', 'SHIPPED', 'DELIVERED') NOT NULL COMMENT '变更后状态',
